          ...
          <tbody>
            ...
            foreach ($usuarios as $key => $value) {
              ...
              if($value["foto"] != ""){
                ...
                echo '<td><img src="vistas/img/usuarios/default/perfilel.jpg" class="img-thumbnail" width="40px"></td>';
          ...
          <div class="form-group">
           ...
           <!-- ENTRADA PARA EL SUBIR FOTO -->
            ...
            <div class="form-group">
              ...
              <img src="vistas/img/usuarios/default/perfilel.jpg" class="img-thumbnail previsualizar" width="100px">
